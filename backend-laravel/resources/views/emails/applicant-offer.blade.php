...
<head>
  ...
  <title>Job Opportunity &mdash; Oxford Suites Makati</title>
</head>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td align="center" style="vertical-align:middle;">
                    ...
                    <p style="margin:8px 0 0;color:#e8c9a0;font-size:10px;letter-spacing:0.25em;font-weight:bold;text-transform:uppercase;">Exciting Career Opportunity</p>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td style="padding:28px 28px 12px;text-align:left;">
              ...
              <p style="margin:0 0 16px;font-size:14px;color:#4b5563;line-height:1.6;">
                We have reviewed your profile and resume at Oxford Suites Makati. We are impressed by your qualifications and would like to offer/refer you to an exciting opening as <strong>{{ $offeredPosition }}</strong>.
              </p>
              @if(!empty($details))
              <div style="background:#fefce8;border:1px solid #fef08a;border-radius:10px;padding:16px;margin:16px 0;">
                <p style="margin:0 0 8px;font-size:13px;font-weight:bold;color:#854d0e;text-transform:uppercase;letter-spacing:0.05em;">Opportunity Details</p>
                <p style="margin:0;font-size:13px;color:#713f12;line-height:1.5;">{{ $details }}</p>
              </div>
              @endif
              <p style="margin:16px 0 0;font-size:14px;color:#4b5563;line-height:1.6;">
                Our HR representative will contact you shortly with the job details and interview arrangements. You may also reply directly to this email to express your interest.
              </p>
            </td>
          </tr>
          <tr>
