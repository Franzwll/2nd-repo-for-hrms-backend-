        ...
        <table role="presentation" width="100%" style="max-width:520px;background-color:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 8px 24px rgba(0,0,0,0.12);border:1px solid #e5e7eb;">
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td align="center" style="vertical-align:middle;">
                    ...
                    <p style="margin:8px 0 0;color:#e8c9a0;font-size:10px;letter-spacing:0.25em;font-weight:bold;text-transform:uppercase;">Employee Portal Access</p>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td style="padding:28px 28px 12px;text-align:left;">
              <h1 style="margin:0 0 12px;font-size:20px;color:#1f2937;">Welcome aboard, {{ $employeeName }}!</h1>
              @if(!empty($position))
              <p style="margin:0 0 16px;font-size:14px;color:#4b5563;line-height:1.6;">
                You have been onboarded as <strong>{{ $position }}</strong>@if(!empty($startDate)) starting <strong>{{ $startDate }}</strong>@endif at Oxford Suites Makati. Your <strong>Employee Portal</strong> account has been created.
              </p>
              @endif
              <div style="background:#fffbeb;border:1px solid #fde68a;border-radius:10px;padding:16px;margin:16px 0;">
                <p style="margin:0 0 8px;font-size:13px;font-weight:bold;color:#92400e;text-transform:uppercase;letter-spacing:0.05em;">Your Login Credentials</p>
                <p style="margin:4px 0;font-size:13px;color:#b45309;"><strong>Email:</strong> {{ $email }}</p>
                <p style="margin:4px 0;font-size:13px;color:#b45309;"><strong>Temporary Password:</strong> {{ $password }}</p>
              </div>
              <p style="margin:16px 0 0;font-size:14px;color:#4b5563;line-height:1.6;">
                Use the credentials above to sign in, view your onboarding checklist, and submit your probationary requirements.
              </p>
            </td>
          </tr>
          <tr>
                ...
                <tr>
                  <td style="padding:14px 16px;text-align:center;">
                    <p style="margin:0;font-size:13px;color:#92400e;line-height:1.6;text-align:center;">
                      <strong>For your security,</strong> please change your password after your first sign-in (Profile &rarr; Security). Never share these credentials with anyone.
                    </p>
                  </td>
                </tr>
              </table>
