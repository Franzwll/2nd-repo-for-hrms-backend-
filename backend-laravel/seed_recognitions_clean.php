...
RecognitionReaction::query()->delete();
SocialRecognition::query()->delete();
...
echo "Successfully seeded " . SocialRecognition::count() . " social recognitions into database table.\n";
