...
('security', '{"twoFactor": true, "passwordPolicy": "Strong", "sessionTimeout": "30 minutes", "maxLoginAttempts": "3 attempts", "passwordPolicyRules": {"minLength": 8, "requireUppercase": true, "requireLowercase": true, "requireNumber": true, "requireSymbol": true}}', 1),
