-- ============================================================================
-- Hotel & Restaurant HR1 - Seed Data (PostgreSQL 15+)
...
-- Notes:
--   * Inserts are ordered so every FK resolves without disabling constraints.
--     system_roles / system_users are loaded right after Domain 1 because
--     Domain 2-4 tables reference them.
...
-- Self-contained: switch to the database created by the schema script.
-- Run with: psql -U postgres -f hotel_hr_seed_postgres.sql
-- NOTE: "\connect" is a psql meta-command (same pgAdmin caveat as the schema).
\connect hotel_hr
...
(1,  'EMP-0001', 'Ana',        'M.',  'Ramos',        'ana.ramos@oxfordsuites.com.ph',           NULL, '0917 100 1001', 'Makati City',                 '1986-05-14', 'Female', 'Married',   'Filipino', NULL, NULL, NULL, NULL, 10, 1, 'Regular',      '2019-02-11', NULL, 'Active', TRUE,  6, '2026-01-10', 'Step 3'),
(2,  'EMP-0002', 'Gabriel',    'S.',  'Mendoza',      'gabriel.mendoza@oxfordsuites.com.ph',      NULL, '0917 100 1002', 'Makati City',                 '1979-11-02', 'Male',   'Married',   'Filipino', NULL, NULL, NULL, NULL, 11, 2, 'Regular',      '2018-06-04', NULL, 'Active', TRUE,  7, '2025-11-02', 'Step 4'),
(3,  'EMP-0003', 'Lourdes',    'B.',  'Bautista',     'lourdes.bautista@oxfordsuites.com.ph',     NULL, '0917 100 1003', 'Quezon City',                 '1971-03-27', 'Female', 'Married',   'Filipino', NULL, NULL, NULL, NULL, 13, 4, 'Regular',      '2017-11-20', NULL, 'Active', TRUE,  6, '2012-06-15', 'Step 3'),
(4,  'EMP-0004', 'Camille',    'T.',  'Ortega',       'camille.ortega@oxfordsuites.com.ph',       NULL, '0917 664 2219', 'Makati City',                 '2001-02-09', 'Female', 'Single',    'Filipino', NULL, NULL, NULL, NULL, 2,  1, 'Probationary', '2026-08-04', NULL, 'Active', FALSE, 4, '2026-01-14', 'Step 1'),
(5,  'EMP-0005', 'Kevin',      'D.',  'Dela Cruz',    'kevin.delacruz@oxfordsuites.com.ph',       NULL, '0921 774 9903', '14 Kalayaan Ave, Makati City', '1998-08-17', 'Male',   'Single',    'Filipino', '34-1234567-8', '12-345678901-2', '1234-5678-9012', '123-456-789', 5, 3, 'Probationary', '2026-04-15', NULL, 'Active', FALSE, 2, '2026-01-20', 'Step 2'),
(6,  'EMP-0006', 'Marjun',     'V.',  'Devera',       'marjun.devera@oxfordsuites.com.ph',        NULL, '0917 664 2219', 'Pasay City',                  '1999-12-03', 'Male',   'Single',    'Filipino', NULL, NULL, NULL, NULL, 3,  2, 'Regular',      '2025-09-16', NULL, 'Active', TRUE,  1, '2011-03-30', 'Step 1'),
(7,  'EMP-0007', 'Juan',       'C.',  'Dela Cruz',    'juan.delacruz@oxfordsuites.com.ph',        NULL, '0917 100 1007', 'Makati City',                 '1982-06-21', 'Male',   'Married',   'Filipino', NULL, NULL, NULL, NULL, 14, 5, 'Regular',      '2016-01-18', NULL, 'Active', TRUE,  7, '2024-08-08', 'Step 3'),
(8,  'EMP-0008', 'Rosa',       'P.',  'Aquino',       'rosa.aquino@oxfordsuites.com.ph',          NULL, '0917 100 1008', 'Taguig City',                 '1990-01-30', 'Female', 'Married',   'Filipino', NULL, NULL, NULL, NULL, 15, 4, 'Regular',      '2021-05-03', NULL, 'Active', TRUE,  4, '2025-05-19', 'Step 2'),
(9,  'EMP-0009', 'Ricardo',    'A.',  'Villanueva',   'ricardo.villanueva@oxfordsuites.com.ph',   NULL, '0917 100 1009', 'Makati City',                 '1975-09-12', 'Male',   'Married',   'Filipino', NULL, NULL, NULL, NULL, 9,  5, 'Regular',      '2015-03-02', NULL, 'Active', TRUE,  7, NULL, 'Step 5'),
(10, 'EMP-0010', 'Marco',      'D.',  'Santos',       'marco.santos@oxfordsuites.com.ph',         NULL, '0917 100 1010', 'Mandaluyong City',            '1980-04-25', 'Male',   'Married',   'Filipino', NULL, NULL, NULL, NULL, 12, 3, 'Regular',      '2017-07-10', NULL, 'Active', TRUE,  7, NULL, 'Step 4'),
(11, 'EMP-0011', 'Maria',      'L.',  'Lim',          'maria.lim@oxfordsuites.com.ph',            NULL, '0917 100 1011', 'Makati City',                 '1993-10-08', 'Female', 'Single',    'Filipino', NULL, NULL, NULL, NULL, 16, 5, 'Regular',      '2020-02-03', NULL, 'Active', TRUE,  4, NULL, 'Step 2'),
(12, 'EMP-0012', 'Paolo',      'R.',  'Cruz',         'paolo.cruz@oxfordsuites.com.ph',           NULL, '0917 100 1012', 'Pasig City',                  '1988-07-15', 'Male',   'Married',   'Filipino', NULL, NULL, NULL, NULL, 17, 5, 'Regular',      '2019-08-19', NULL, 'Active', TRUE,  4, NULL, 'Step 2'),
(13, 'EMP-0013', 'Bianca',     'S.',  'Soriano',      'bianca.soriano@oxfordsuites.com.ph',       NULL, '0912 345 6789', 'Manila',                     '2000-04-22', 'Female', 'Single',    'Filipino', NULL, NULL, NULL, NULL, 1,  1, 'Probationary', '2026-08-04', NULL, 'Active', FALSE, 2, NULL, 'Step 1'),
(14, 'EMP-0014', 'Jompaks',    'B.',  'Berdugo',      'jompaks.berdugo@oxfordsuites.com.ph',      NULL, '0933 552 1180', 'Parañaque City',              '1996-09-05', 'Male',   'Single',    'Filipino', NULL, NULL, NULL, NULL, 4,  2, 'Probationary', '2026-03-01', NULL, 'Active', TRUE,  1, NULL, 'Step 1'),
(15, 'EMP-0015', 'Angelo',     'T.',  'Torres',       'angelo.torres@oxfordsuites.com.ph',        NULL, '0917 220 5541', 'Makati City',                 '1999-03-18', 'Male',   'Single',    'Filipino', NULL, NULL, NULL, NULL, 1,  1, 'Probationary', '2026-05-11', NULL, 'Active', FALSE, 2, NULL, 'Step 1'),
(16, 'EMP-0016', 'Ligaya',     'S.',  'Santos',       'ligaya.santos@oxfordsuites.com.ph',        NULL, '0918 663 2201', 'Caloocan City',               '1987-12-11', 'Female', 'Married',   'Filipino', NULL, NULL, NULL, NULL, 7,  4, 'Probationary', '2026-02-20', NULL, 'Active', FALSE, 1, NULL, 'Step 1'),
(17, 'EMP-0017', 'Michael',    'R.',  'Reyes',        'michael.reyes@oxfordsuites.com.ph',        NULL, '0920 441 8873', 'Quezon City',                 '2002-01-27', 'Male',   'Single',    'Filipino', NULL, NULL, NULL, NULL, 8,  5, 'Probationary', '2026-06-01', NULL, 'Active', FALSE, 3, NULL, 'Step 1'),
(18, 'EMP-0018', 'Patricia',   'G.',  'Gomez',        'patricia.gomez@oxfordsuites.com.ph',       NULL, '0917 903 2245', 'Makati City',                 '1991-06-09', 'Female', 'Married',   'Filipino', NULL, NULL, NULL, NULL, 6,  3, 'Regular',      '2025-06-02', NULL, 'Active', TRUE,  5, NULL, 'Step 2'),
(19, 'EMP-0019', 'Ernesto',    'V.',  'Villar',       'ernesto.villar@oxfordsuites.com.ph',       NULL, '0921 556 7743', 'Manila',                      '1985-05-30', 'Male',   'Married',   'Filipino', NULL, NULL, NULL, NULL, 7,  4, 'Regular',      '2025-03-19', NULL, 'Active', TRUE,  1, NULL, 'Step 2'),
(20, 'EMP-0020', 'Grace',      'P.',  'Panganiban',   'grace.panganiban@oxfordsuites.com.ph',     NULL, '0917 332 8890', 'Makati City',                 '1997-02-14', 'Female', 'Single',    'Filipino', NULL, NULL, NULL, NULL, 2,  1, 'Regular',      '2025-11-10', NULL, 'Active', FALSE, 4, NULL, 'Step 1'),
(21, 'EMP-0021', 'Noel',       'F.',  'Fajardo',      'noel.fajardo@oxfordsuites.com.ph',         NULL, '0918 774 3320', 'Valenzuela City',             '1984-10-19', 'Male',   'Married',   'Filipino', NULL, NULL, NULL, NULL, 8,  5, 'Regular',      '2025-01-27', NULL, 'Active', TRUE,  3, NULL, 'Step 2'),
(22, 'EMP-0022', 'Miguel',     'T.',  'Torres',       'miguel.torres@oxfordsuites.com.ph',        NULL, '0917 442 1177', 'Makati City',                 '1998-11-25', 'Male',   'Single',    'Filipino', NULL, NULL, NULL, NULL, 1,  1, 'Probationary', '2026-05-04', NULL, 'Active', FALSE, 2, NULL, 'Step 1'),
(23, 'EMP-0023', 'Andrea',     'L.',  'Lim',          'andrea.lim@oxfordsuites.com.ph',           NULL, '0917 883 5566', 'Mandaluyong City',            '1999-08-02', 'Female', 'Single',    'Filipino', NULL, NULL, NULL, NULL, 7,  4, 'Probationary', '2026-03-06', NULL, 'Active', FALSE, 1, NULL, 'Step 1');
...
(5,  'Liza Santos',       'Spouse',  '0918 222 4410', '14 Kalayaan Ave, Makati City',  TRUE),
(1,  'Daniel Ramos',      'Spouse',  '0917 555 1212', 'Makati City',                    TRUE),
(4,  'Lorna Ortega',      'Mother',  '0917 888 2323', 'San Fernando, Pampanga',         TRUE),
(6,  'Fely Devera',       'Mother',  '0917 777 3434', 'Pasay City',                     TRUE),
(8,  'Ramon Aquino',      'Spouse',  '0917 666 4545', 'Taguig City',                    TRUE),
(13, 'Nelia Soriano',     'Mother',  '0912 345 6789', 'Manila',                         TRUE),
(14, 'Bert Berdugo',      'Father',  '0933 552 1180', 'Parañaque City',                 TRUE),
(15, 'Sonia Torres',      'Mother',  '0917 220 5541', 'Makati City',                    TRUE),
(16, 'Mario Santos',      'Spouse',  '0918 663 2201', 'Caloocan City',                  TRUE),
(22, 'Teresa Torres',     'Mother',  '0917 442 1177', 'Makati City',                    TRUE);
...
-- ---------------------------------------------------------------------------
-- Domain 7 (core): Access Control & System Users
-- Loaded early because Domains 2-4 reference system_users.
-- ---------------------------------------------------------------------------
...
(2, 'ess_request',  'New ESS request pending',      'Sick leave request REQ-4410 filed by Kevin Dela Cruz awaits review.',    'ESS Management', 'ess_request', 'REQ-4410', FALSE, NULL),
(2, 'hr3',          'HR3 recommendation pending',   'Regularization recommendation for Camille Ortega is pending HR action.', 'Core HCM',       'hr3_recommendation', 'HR3-REC-01', FALSE, NULL),
(2, 'checklist',    'Checklist request raised',     'Miguel Torres probationary checklist requested (CR-001).',                'New Hire Onboarding', 'checklist_request', 'CR-001', FALSE, NULL),
(2, 'checklist',    'Checklist request raised',     'Andrea Lim probationary checklist requested (CR-002).',                   'New Hire Onboarding', 'checklist_request', 'CR-002', FALSE, NULL),
(3, 'ess_request',  'Interview reminder',           'Interview with Bianca Soriano scheduled for 2026-07-28, 09:00 AM.',       'Applicant Management', 'interview', 'INT-201', FALSE, NULL),
(3, 'hr3',          'HR3 recommendation submitted', 'Regularization recommendation for Camille Ortega submitted for review.',   'Core HCM',       'hr3_recommendation', 'HR3-REC-01', TRUE, '2026-08-02 09:00:00'),
(1, 'audit',        'Critical audit event',         'Permission matrix was modified for role Admin.',                            'User Management', 'audit_log', 'LOG-9001', FALSE, NULL),
(7, 'ess_request',  'COE request assigned',         'Certificate of Employment request REQ-4409 assigned to you.',              'ESS Management', 'ess_request', 'REQ-4409', FALSE, NULL),
(8, 'ess_request',  'Loan application under review','Company loan application REQ-4405 assigned to you.',                       'ESS Management', 'ess_request', 'REQ-4405', FALSE, NULL);
...
(1, 'front-desk-receptionist', 'Front Desk Receptionist', 1, 1, 'Full-time', 'Shifting Schedule', 18000.00, 22000.00, 3, 1, '2026-05-22', 'Open', TRUE, '1-2 Years', 'Bachelor''s Degree',
 ...
 '["Welcome and assist hotel guests.","Process check-in and check-out procedures.","Manage room reservations.","Handle guest inquiries and complaints professionally.","Coordinate with housekeeping and other departments.","Answer phone calls and emails."]'::jsonb,
 '["Bachelor''s degree or College level in Hospitality Management or related field.","Excellent communication and interpersonal skills.","Basic computer skills.","Customer service experience is an advantage.","Willing to work shifts, weekends, and holidays."]'::jsonb,
 '["Customer Service","Communication","Hotel Operations","Problem Solving","Time Management"]'::jsonb,
 '["HMO","Service Charge","Paid Leave","Meal Allowance","Career Growth"]'::jsonb),
(2, 'line-cook', 'Line Cook', 3, 5, 'Full-time', 'Shifting Schedule', 16000.00, 20000.00, 4, 2, '2026-05-18', 'Open', TRUE, '1-2 Years', 'Vocational / TESDA',
 ...
 '["Prepare mise en place before each service.","Cook and plate dishes to recipe standards.","Maintain sanitation and food-safety compliance.","Monitor inventory levels of station ingredients.","Support banquet and room-service volume peaks."]'::jsonb,
 '["TESDA NC II in Cookery or equivalent culinary training.","At least 1 year in a hotel or full-service restaurant kitchen.","Valid food handler''s certificate.","Able to work under pressure during peak service."]'::jsonb,
 '["Food Safety","HACCP","Knife Skills","Plating","Teamwork"]'::jsonb,
 '["HMO","Service Charge","Meal Allowance","Uniform","Training"]'::jsonb),
(3, 'housekeeping-attendant', 'Housekeeping Attendant', 4, 7, 'Full-time', 'Shifting Schedule', 14000.00, 17000.00, 5, 3, '2026-05-10', 'Open', TRUE, 'No Experience', 'High School Graduate',
 ...
 '["Clean and prepare assigned guestrooms daily.","Replenish linens, towels, and amenities.","Report maintenance and lost-and-found items.","Maintain housekeeping cart and supplies."]'::jsonb,
 '["High School Graduate.","Physically fit and detail-oriented.","Willing to work shifts including weekends and holidays."]'::jsonb,
 '["Attention to Detail","Time Management","Room Turnover","Safety"]'::jsonb,
 '["HMO","Service Charge","Meal Allowance","Uniform"]'::jsonb),
(4, 'restaurant-server', 'Restaurant Server', 2, 3, 'Full-time', 'Shifting Schedule', 15000.00, 18000.00, 4, 1, '2026-05-20', 'Open', TRUE, 'No Experience', 'High School Graduate',
 ...
 '["Greet and seat guests warmly.","Take and relay orders accurately to the kitchen.","Serve food and beverages following service sequence.","Handle billing and guest feedback."]'::jsonb,
 '["High School Graduate; hospitality training an advantage.","Good communication skills in English and Filipino.","Pleasant personality and grooming."]'::jsonb,
 '["Guest Service","Upselling","POS Systems","Communication"]'::jsonb,
 '["HMO","Service Charge","Meal Allowance","Tips"]'::jsonb),
(5, 'bartender', 'Bartender', 2, 4, 'Part-time', 'Night Shift', 16000.00, 19000.00, 2, 0, '2026-05-15', 'Open', TRUE, '3-5 Years', 'Vocational / TESDA',
 ...
 '["Prepare cocktails and beverages to standard.","Maintain bar cleanliness and inventory.","Engage guests and recommend pairings.","Observe responsible alcohol service."]'::jsonb,
 '["TESDA Bartending NC II or equivalent.","At least 3 years bar experience in hotels or restaurants.","Knowledge of classic and modern mixology."]'::jsonb,
 '["Mixology","Inventory Control","Guest Engagement","Cash Handling"]'::jsonb,
 '["HMO","Service Charge","Meal Allowance","Night Differential"]'::jsonb),
(6, 'hr-assistant', 'HR Assistant', 5, 8, 'Full-time', 'Day Shift', 20000.00, 25000.00, 1, 0, '2026-05-08', 'Open', FALSE, '1-2 Years', 'Bachelor''s Degree',
 ...
 '["Coordinate interview schedules with department heads.","Maintain complete and accurate 201 files.","Process COE and employment verification requests.","Assist in new-hire onboarding documentation."]'::jsonb,
 '["Bachelor''s degree in Psychology, HR, or related field.","At least 1 year HR experience.","Strong organizational and documentation skills."]'::jsonb,
 '["Recruitment","Documentation","MS Office","Confidentiality"]'::jsonb,
 '["HMO","Paid Leave","Career Growth","Training"]'::jsonb);
...
(1,  'APP-1032', 1, 'Camille Ortega',     'camille.ortega@email.com',     '0917 664 2219', '2026-07-22 15:47:00', 93.00, 'fit',        'Hired',              'Referral',     '/uploads/resumes/camille_ortega_resume.pdf', 'Referred by Front Office Manager; completed practical assessment with 94%.', '[]'::jsonb),
(2,  'APP-1033', 6, 'Juan De La Cruz',    'juan.delacruz@email.com',      '0912 345 6789', '2026-07-23 09:31:00', 76.00, 'fit',        'Interview Scheduled', 'Indeed',       '/uploads/resumes/juan_delacruz_resume.pdf',   'Agency recruitment coordinator transitioning to in-house HR.', '[]'::jsonb),
(3,  'APP-1034', 3, 'Mark Reyes',         'mark.reyes@email.com',         '0908 441 2277', '2026-07-24 11:05:00', 69.00, 'other-role', 'Screened',           'Walk-in',      '/uploads/resumes/mark_reyes_resume.pdf',      'Building maintenance background; endorse to Facilities vacancy.', '["Stronger match: Facilities Maintenance (81%)"]'::jsonb),
(4,  'APP-1035', 5, 'Jompaks Berdugo',    'jompaks.berdugo@email.com',    '0933 552 1180', '2026-07-24 14:22:00', 84.00, 'fit',        'Assessed',           'Facebook',     '/uploads/resumes/jompaks_berdugo_resume.pdf',  'Rooftop bar experience with strong signature-cocktail portfolio.', '[]'::jsonb),
(5,  'APP-1036', 2, 'Kevin Dela Cruz',    'kevin.delacruz@email.com',     '0921 774 9903', '2026-07-24 16:48:00', 91.00, 'fit',        'Offer',              'Online Portal', '/uploads/resumes/kevin_delacruz_resume.pdf',   'Certified cook with four years hot-kitchen experience across two hotel outlets.', '[]'::jsonb),
(6,  'APP-1037', 2, 'Elena Torres',       'elena.torres@email.com',       '0918 220 3341', '2026-07-25 19:02:00', 22.00, 'not-fit',    'Rejected',           'Online Portal', '/uploads/resumes/elena_torres_resume.pdf',     'Clerical background with no hospitality or culinary entities detected.', '["No culinary certification","No kitchen experience detected"]'::jsonb),
(7,  'APP-1038', 3, 'Princess Mabangis',  'princess.mabangis@email',      '0912 345',      '2026-07-25 20:10:00', 58.00, 'credential', 'Screened',           'Walk-in',      '/uploads/resumes/princess_mabangis_resume.pdf', 'Relevant housekeeping experience but contact details failed NER validation.', '["Malformed email address","Incomplete phone number","Job position typo on application form"]'::jsonb),
(8,  'APP-1039', 1, 'Kanor Ornak',        'kanor.ornak@email.com',        '0905 118 7742', '2026-07-25 21:12:00', 74.00, 'other-role', 'Screened',           'Indeed',       '/uploads/resumes/kanor_ornak_resume.pdf',      'Retail and cafe service background; better aligned to F&B service roles.', '["Stronger match: Restaurant Server (86%)"]'::jsonb),
(9,  'APP-1040', 4, 'Marjun Devera',      'marjun.devera@email.com',      '0917 664 2219', '2026-07-25 22:40:00', 88.00, 'fit',        'Screened',           'Referral',     '/uploads/resumes/marjun_devera_resume.pdf',    'Strong dining-room service background with banquet exposure.', '[]'::jsonb),
(10, 'APP-1041', 1, 'Bianca Soriano',     'bianca.soriano@email.com',     '0912 345 6789', '2026-07-25 23:15:00', 96.00, 'fit',        'Interview Scheduled', 'Online Portal', '/uploads/resumes/bianca_soriano_resume.pdf',   'Three years front office experience at a 4-star property, PMS proficient, complete credentials.', '[]'::jsonb);
...
(1, 1, 2, '2026-07-23', '{"Guest Service Orientation":19,"Communication Skills":18,"Technical / Practical Skill":20,"Grooming & Professionalism":18,"Availability & Flexibility":19}'::jsonb, 94.00, 'Recommended', 'Practical front desk simulation passed with 94%. Advanced to job offer.'),
(2, 5, 2, '2026-07-26', '{"Guest Service Orientation":16,"Communication Skills":17,"Technical / Practical Skill":18,"Grooming & Professionalism":16,"Availability & Flexibility":15}'::jsonb, 82.00, 'Recommended', 'Cook test assessment passed; solid knife skills and station timing.'),
(3, 4, 2, '2026-07-27', '{"Guest Service Orientation":17,"Communication Skills":18,"Technical / Practical Skill":19,"Grooming & Professionalism":17,"Availability & Flexibility":17}'::jsonb, 88.00, 'Recommended', 'Mixology practical assessment passed with 88%.');
...
(1, 'TPL-001', 'Pre-Employment Requirements', 'Pre-onboarding', '["all"]'::jsonb, 'Active'),
(2, 'TPL-002', 'Standard Probationary Checklist', 'Probationary', '["all"]'::jsonb, 'Active'),
(3, 'TPL-003', 'Regularization Checklist', 'Regular', '["all"]'::jsonb, 'Active');
...
(4,  1, 1,  'Signed employment contract',             TRUE,  '2026-08-01 10:00:00', 2),
(4,  1, 2,  'NBI / Police clearance',                TRUE,  '2026-08-01 10:05:00', 2),
(4,  1, 3,  'Pre-employment medical exam',           FALSE, NULL, NULL),
(4,  1, 4,  'SSS / PhilHealth / Pag-IBIG / TIN',     FALSE, NULL, NULL),
(4,  1, 5,  'Birth certificate (PSA)',               FALSE, NULL, NULL),
(4,  1, 6,  'Company orientation attended',          FALSE, NULL, NULL),
(4,  1, 7,  'Uniform & ID issued',                   FALSE, NULL, NULL),
(4,  1, 8,  'Department on-the-job training',        FALSE, NULL, NULL),
(13, 2, 1,  'Signed employment contract',             TRUE,  '2026-08-01 10:10:00', 2),
(13, 2, 2,  'NBI / Police clearance',                TRUE,  '2026-08-01 10:12:00', 2),
(13, 2, 3,  'Pre-employment medical exam',           TRUE,  '2026-08-02 09:00:00', 2),
(13, 2, 4,  'SSS / PhilHealth / Pag-IBIG / TIN',     TRUE,  '2026-08-02 09:30:00', 2),
(13, 2, 5,  'Birth certificate (PSA)',               TRUE,  '2026-08-02 10:00:00', 2),
(13, 2, 6,  'Company orientation attended',          FALSE, NULL, NULL),
(13, 2, 7,  'Uniform & ID issued',                   FALSE, NULL, NULL),
(13, 2, 8,  'Department on-the-job training',        FALSE, NULL, NULL),
(5,  3, 1,  'Signed employment contract',             TRUE,  '2026-04-13 10:00:00', 2),
(5,  3, 2,  'NBI / Police clearance',                TRUE,  '2026-04-13 10:10:00', 2),
(5,  3, 3,  'Pre-employment medical exam',           TRUE,  '2026-04-14 09:00:00', 2),
(5,  3, 4,  'SSS / PhilHealth / Pag-IBIG / TIN',     TRUE,  '2026-04-14 09:20:00', 2),
(5,  3, 5,  'Birth certificate (PSA)',               TRUE,  '2026-04-14 09:40:00', 2),
(5,  3, 6,  'Company orientation attended',          TRUE,  '2026-04-15 08:00:00', 2),
(5,  3, 7,  'Uniform & ID issued',                   TRUE,  '2026-04-15 08:30:00', 2),
(5,  3, 8,  'Department on-the-job training',        FALSE, NULL, NULL),
(14, 4, 1,  'Signed employment contract',             TRUE,  '2026-02-26 10:00:00', 2),
(14, 4, 2,  'NBI / Police clearance',                TRUE,  '2026-02-26 10:10:00', 2),
(14, 4, 3,  'Pre-employment medical exam',           TRUE,  '2026-02-27 09:00:00', 2),
(14, 4, 4,  'SSS / PhilHealth / Pag-IBIG / TIN',     TRUE,  '2026-02-27 09:30:00', 2),
(14, 4, 5,  'Birth certificate (PSA)',               TRUE,  '2026-02-27 10:00:00', 2),
(14, 4, 6,  'Company orientation attended',          TRUE,  '2026-02-28 08:00:00', 2),
(14, 4, 7,  'Uniform & ID issued',                   TRUE,  '2026-02-28 08:30:00', 2),
(14, 4, 8,  'Department on-the-job training',        TRUE,  '2026-02-28 16:00:00', 2),
(6,  5, 1,  'Signed employment contract',             TRUE,  '2025-09-12 10:00:00', 2),
(6,  5, 2,  'NBI / Police clearance',                TRUE,  '2025-09-12 10:10:00', 2),
(6,  5, 3,  'Pre-employment medical exam',           TRUE,  '2025-09-13 09:00:00', 2),
(6,  5, 4,  'SSS / PhilHealth / Pag-IBIG / TIN',     TRUE,  '2025-09-13 09:30:00', 2),
(6,  5, 5,  'Birth certificate (PSA)',               TRUE,  '2025-09-13 10:00:00', 2),
(6,  5, 6,  'Company orientation attended',          TRUE,  '2025-09-15 08:00:00', 2),
(6,  5, 7,  'Uniform & ID issued',                   TRUE,  '2025-09-15 08:30:00', 2),
(6,  5, NULL, 'Regularization evaluation passed',    TRUE,  '2026-03-15 14:00:00', 2),
(15, 6, 9,  'Department orientation completed',       TRUE,  '2026-05-11 08:00:00', 2),
(15, 6, 10, 'Job description acknowledged',          TRUE,  '2026-05-11 08:20:00', 2),
(15, 6, 11, '1st month performance evaluation',      TRUE,  '2026-06-10 09:00:00', 2),
(15, 6, 12, '3rd month performance evaluation',      FALSE, NULL, NULL),
(15, 6, 13, '5th month performance evaluation',      FALSE, NULL, NULL),
(15, 6, 14, 'Training hours completed',              FALSE, NULL, NULL),
(16, 7, 9,  'Department orientation completed',       TRUE,  '2026-02-20 08:00:00', 2),
(16, 7, 10, 'Job description acknowledged',          TRUE,  '2026-02-20 08:20:00', 2),
(16, 7, 11, '1st month performance evaluation',      TRUE,  '2026-03-20 09:00:00', 2),
(16, 7, 12, '3rd month performance evaluation',      TRUE,  '2026-05-20 09:00:00', 2),
(16, 7, 13, '5th month performance evaluation',      FALSE, NULL, NULL),
(16, 7, 14, 'Training hours completed',              FALSE, NULL, NULL),
(17, 8, 9,  'Department orientation completed',       TRUE,  '2026-06-01 08:00:00', 2),
(17, 8, 10, 'Job description acknowledged',          FALSE, NULL, NULL),
(17, 8, 11, '1st month performance evaluation',      FALSE, NULL, NULL),
(17, 8, 12, '3rd month performance evaluation',      FALSE, NULL, NULL),
(17, 8, 13, '5th month performance evaluation',      FALSE, NULL, NULL),
(17, 8, 14, 'Training hours completed',              FALSE, NULL, NULL),
(18, 9, 15, 'Regularization contract signed',        TRUE,  '2025-05-30 10:00:00', 2),
(18, 9, 16, 'HMO enrollment submitted',             TRUE,  '2025-05-30 10:30:00', 2),
(18, 9, 17, 'Leave credits activated',              TRUE,  '2025-06-02 09:00:00', 2),
(18, 9, 18, 'Performance goals set',                 TRUE,  '2025-06-02 09:30:00', 2),
(19, 10, 15, 'Regularization contract signed',       TRUE,  '2025-03-14 10:00:00', 2),
(19, 10, 16, 'HMO enrollment submitted',            TRUE,  '2025-03-14 10:30:00', 2),
(19, 10, 17, 'Leave credits activated',             TRUE,  '2025-03-17 09:00:00', 2),
(19, 10, 18, 'Performance goals set',                TRUE,  '2025-03-17 09:30:00', 2),
(20, 11, 15, 'Regularization contract signed',       TRUE,  '2025-11-07 10:00:00', 2),
(20, 11, 16, 'HMO enrollment submitted',            TRUE,  '2025-11-07 10:30:00', 2),
(20, 11, 17, 'Leave credits activated',             TRUE,  '2025-11-10 09:00:00', 2),
(20, 11, 18, 'Performance goals set',                FALSE, NULL, NULL),
(21, 12, 15, 'Regularization contract signed',       TRUE,  '2025-01-23 10:00:00', 2),
(21, 12, 16, 'HMO enrollment submitted',            TRUE,  '2025-01-23 10:30:00', 2),
(21, 12, 17, 'Leave credits activated',             TRUE,  '2025-01-27 09:00:00', 2),
(21, 12, 18, 'Performance goals set',                TRUE,  '2025-01-27 09:30:00', 2);
...
(1, 'CR-001', 22, 2, 'Probationary', '["Guest-handling scenario evaluation","PMS (Opera) proficiency check","Supervisor sign-off: guest complaints handling","Supervisor sign-off: reservations process"]'::jsonb, 'Pending', 2, '2026-08-04'),
(2, 'CR-002', 23, 2, 'Probationary', '["Room-turnover timing check (30-minute SLA)","Chemical-handling and safety procedure","Linen and amenities restocking check","Supervisor sign-off"]'::jsonb, 'Pending', 2, '2026-08-06');
...
(1, 'ESS-LEAVE',  'Leave',          'Vacation, sick, emergency and other leave filings.', TRUE, 1),
(2, 'ESS-ATT',    'Attendance',     'Time in/out corrections, overtime and shift changes.', TRUE, 2),
(3, 'ESS-PAY',    'Payroll',        'Payslips, payroll inquiries and salary certificates.', TRUE, 3),
(4, 'ESS-PAYUPD', 'Payroll Update', 'Bank account, payment method and deduction updates.', TRUE, 4),
(5, 'ESS-LOAN',   'Loan',           'Company loans, salary loans and cash advances.', TRUE, 5),
(6, 'ESS-REIMB',  'Reimbursement',  'Transportation, travel and other expense claims.', TRUE, 6),
(7, 'ESS-HRDOC',  'HR Document',    'Certificates, service records and employment verification.', TRUE, 7),
(8, 'ESS-PINFO',  'Personal Info',  'Address, contact, civil status and government ID updates.', TRUE, 8),
(9, 'ESS-ACCT',   'Account',        'Password resets and ESS account access issues.', TRUE, 9);
...
(5, 0, 'AM Shift', '07:00:00', '16:00:00', 'Main Kitchen', FALSE, '2026-07-01', NULL),
(5, 1, 'AM Shift', '07:00:00', '16:00:00', 'Main Kitchen', FALSE, '2026-07-01', NULL),
(5, 2, 'Mid Shift', '11:00:00', '20:00:00', 'Banquet',      FALSE, '2026-07-01', NULL),
(5, 3, 'Mid Shift', '11:00:00', '20:00:00', 'Banquet',      FALSE, '2026-07-01', NULL),
(5, 4, 'PM Shift', '14:00:00', '23:00:00', 'Main Kitchen', FALSE, '2026-07-01', NULL),
(5, 5, NULL,        NULL,        NULL,        NULL,          TRUE,  '2026-07-01', NULL),
(5, 6, NULL,        NULL,        NULL,        NULL,          TRUE,  '2026-07-01', NULL);
...
-- ---------------------------------------------------------------------------
-- Domain 7 (remaining): Audit Logs, Announcements, System Settings
-- ---------------------------------------------------------------------------
...
('company.name', '{"value": "Oxford Suites Makati"}'::jsonb, 1),
('company.timezone', '{"value": "Asia/Manila"}'::jsonb, 1),
('password_policy', '{"minLength": 8, "requireUppercase": true, "requireLowercase": true, "requireNumber": true, "requireSymbol": true}'::jsonb, 1),
('recruitment.screening.enabled', '{"value": true}'::jsonb, 1),
('ess.default_processing_role', '{"value": "Admin"}'::jsonb, 1);