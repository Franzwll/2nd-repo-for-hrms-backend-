...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 22, 2026 at 11:00 PM
...
('oxford-suites-hrms-cache-5c785c036466adea360111aa28563bfd556b5fba', 'i:2;', 1787428883),
('oxford-suites-hrms-cache-5c785c036466adea360111aa28563bfd556b5fba:timer', 'i:1787428883;', 1787428883),
...
(1, 'App\\Models\\SystemUser', 14, 'auth-token', 'c902832860a09e26ca641d4d36dd2ee282f6dada9cead92b6840e8759d915ca0', '[\"*\"]', '2026-08-22 12:34:28', NULL, '2026-08-22 12:00:45', '2026-08-22 12:34:28');
...
(1, 'bullseur', 'bullseur@oxfordsuites.com.ph', '$2y$12$mBDKW2CNIrhr8HU7zrMW5eAHeQHBdnv5uzlxmSze30SL8CRkaIlRW', 'Bullseur Santiago', 'Administration / HR', NULL, 1, 'Active', '2026-07-26 00:12:00', '192.168.10.4', '2026-08-17 17:41:34', '2026-08-22 11:51:43'),
...
--
ALTER TABLE `applicants`
  MODIFY `applicant_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `audit_logs`
  MODIFY `audit_log_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;
...
--
ALTER TABLE `user_login_activity`
  MODIFY `login_activity_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
