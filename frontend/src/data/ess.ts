...
export const requestCategories = [
  ...
  {
    name: "Payroll Update",
    types: ["Bank Account Update", "Payment Method", "Voluntary Deduction"],
  },
  { name: "Loan", types: ["Company Loan", "Salary Loan", "Cash Advance", "Emergency Loan"] },
  {
    name: "Reimbursement",
    types: ["Transportation", "Travel", "Meal Allowance", "Hotel Expense", "Communication"],
  },
  {
    name: "HR Document",
    types: [
  ...
  {
    name: "Account",
    types: ["Password Reset", "Unlock Account", "System Access", "Login Problem"],
  },
];
...
const essCategoryDescriptions: Record<string, string> = {
  Leave: "Vacation, sick, emergency and other leave filings.",
  Attendance: "Time in/out corrections, overtime and shift changes.",
  Payroll: "Payslips, payroll inquiries and salary certificates.",
  "Payroll Update": "Bank account, payment method and deduction updates.",
  Loan: "Company loans, salary loans and cash advances.",
  Reimbursement: "Transportation, travel and other expense claims.",
  "HR Document": "Certificates, service records and employment verification.",
  "Personal Info": "Address, contact, civil status and government ID updates.",
  Account: "Password resets and ESS account access issues.",
};

let essCategoryStore: EssCategory[] = requestCategories.map((c) => ({
  name: c.name,
  description: essCategoryDescriptions[c.name] ?? "",
  types: [...c.types],
  open: true,
}));

type EssCategoryListener = () => void;
const essCategoryListeners = new Set<EssCategoryListener>();

function notifyEssCategoryListeners() {
  essCategoryListeners.forEach((listener) => listener());
}

/** Live-updating list of ESS request categories, kept in sync across all components using it. */
export function useEssCategories(): EssCategory[] {
  const [, forceRender] = useState(0);

  useEffect(() => {
    const listener = () => forceRender((n) => n + 1);
    essCategoryListeners.add(listener);
    return () => {
      essCategoryListeners.delete(listener);
    };
  }, []);

  return essCategoryStore;
}
...
export function updateCategoryEntry(
  originalName: string,
  updates: { name: string; description: string; types: string[] },
) {
  essCategoryStore = essCategoryStore.map((c) =>
    c.name === originalName ? { ...c, ...updates } : c,
  );
  notifyEssCategoryListeners();
}

export function removeCategoryEntry(name: string) {
  essCategoryStore = essCategoryStore.filter((c) => c.name !== name);
  notifyEssCategoryListeners();
}

export function setCategoryOpen(name: string, open: boolean) {
  essCategoryStore = essCategoryStore.map((c) => (c.name === name ? { ...c, open } : c));
  notifyEssCategoryListeners();
}
...
export const essActivityLog: EssActivityLog[] = [
  {
    ...
    user: "Juan Dela Cruz",
    action: "Approved sick leave request",
    module: "Leave",
    category: "Leave",
    department: "Kitchen / Culinary",
    requestId: "REQ-4410",
  ...
  {
    id: "ELOG-002",
    timestamp: "2026-07-26 07:58",
    user: "Maria Lim",
    action: "Reviewed COE request",
    module: "HR Document",
    category: "HR Document",
    department: "Food & Beverage",
    requestId: "REQ-4409",
  },
  {
    ...
    user: "Rosa Aquino",
    action: "Filed attendance correction",
    module: "Attendance",
    category: "Attendance",
    department: "Housekeeping",
    requestId: "REQ-4408",
  ...
  {
    id: "ELOG-004",
    timestamp: "2026-07-25 19:12",
    user: "Paolo Cruz",
    action: "Released payslip copies",
    module: "Payroll",
    category: "Payroll",
    department: "Front Office",
    requestId: "REQ-4407",
  },
  {
    ...
    user: "Paolo Cruz",
    action: "Rejected transportation reimbursement",
  ...
  {
    id: "ELOG-006",
    timestamp: "2026-07-24 14:05",
    user: "Ana Ramos",
    action: "Submitted company loan application",
    module: "Loan",
    category: "Loan",
    department: "Front Office",
    requestId: "REQ-4405",
  ...
  {
    id: "ELOG-008",
    timestamp: "2026-07-24 09:20",
    user: "Kevin Dela Cruz",
    action: "Filed sick leave request",
    module: "Leave",
    category: "Leave",
    department: "Kitchen / Culinary",
    requestId: "REQ-4410",
  ...
  {
    id: "ELOG-009",
    timestamp: "2026-07-23 20:10",
    user: "Marjun Devera",
    action: "Requested certificate of employment",
    module: "HR Document",
    category: "HR Document",
    department: "Food & Beverage",
    requestId: "REQ-4409",
  ...
  {
    id: "ELOG-010",
    timestamp: "2026-07-23 18:02",
    user: "Juan Dela Cruz",
    action: "Verified floor logbook entry",
    module: "Attendance",
    category: "Attendance",
    department: "Housekeeping",
    requestId: "REQ-4408",
  ...
  {
    id: "ELOG-011",
    timestamp: "2026-07-23 15:33",
    user: "Camille Ortega",
    action: "Requested June payslip",
    module: "Payroll",
    category: "Payroll",
    department: "Front Office",
    requestId: "REQ-4407",
  },
  {
    ...
    user: "Kevin Dela Cruz",
    action: "Filed transportation reimbursement",
    module: "Reimbursement",
    category: "Reimbursement",
    department: "Kitchen / Culinary",
    requestId: "REQ-4406",
  ...
  {
    id: "ELOG-013",
    timestamp: "2026-07-22 10:44",
    user: "Paolo Cruz",
    action: "Escalated loan application to HR",
    module: "Loan",
    category: "Loan",
    department: "Front Office",
    requestId: "REQ-4405",
  ...
  {
    id: "ELOG-017",
    timestamp: "2026-07-20 22:47",
    user: "Ana Ramos",
    action: "Uploaded loan supporting document",
    module: "Loan",
    category: "Loan",
    department: "Front Office",
    requestId: "REQ-4405",
  ...
  {
    id: "ELOG-018",
    timestamp: "2026-07-20 19:26",
    user: "Kevin Dela Cruz",
    action: "Checked leave balance",
    module: "Leave",
    category: "Leave",
    department: "Kitchen / Culinary",
    requestId: "REQ-4410",
  ...
  {
    id: "ELOG-020",
    timestamp: "2026-07-19 23:18",
    user: "Rosa Aquino",
    action: "Completed contact info update",
    module: "Personal Info",
    category: "Personal Info",
    department: "Housekeeping",
    requestId: "REQ-4404",
  ...
  {
    id: "ELOG-021",
    timestamp: "2026-07-19 20:04",
    user: "Marjun Devera",
    action: "Resubmitted COE request",
    module: "HR Document",
    category: "HR Document",
    department: "Food & Beverage",
    requestId: "REQ-4409",
  ...
  {
    id: "ELOG-022",
    timestamp: "2026-07-19 16:52",
    user: "Paolo Cruz",
    action: "Denied transportation reimbursement appeal",
    module: "Reimbursement",
    category: "Reimbursement",
    department: "Kitchen / Culinary",
    requestId: "REQ-4406",
  ...
  {
    id: "ELOG-023",
    timestamp: "2026-07-18 14:33",
    user: "Maria Lim",
    action: "Unlocked ESS account",
    module: "Account",
    category: "Account",
    department: "Food & Beverage",
    requestId: "REQ-4409",
  ...
  {
    id: "ELOG-024",
    timestamp: "2026-07-18 11:20",
    user: "Ana Ramos",
    action: "Signed loan agreement",
    module: "Loan",
    category: "Loan",
    department: "Front Office",
    requestId: "REQ-4405",
  ...
  {
    id: "ELOG-025",
    timestamp: "2026-07-17 09:47",
    user: "Kevin Dela Cruz",
    action: "Marked sick leave as completed",
    module: "Leave",
    category: "Leave",
    department: "Kitchen / Culinary",
    requestId: "REQ-4410",
...
export const myLearningCourses = [
  {
    id: "LMS-101",
    title: "Food Safety & Sanitation Level 2",
    category: "Culinary & Safety",
    status: "Completed",
    score: "95%",
  ...
  {
    id: "LMS-102",
    title: "Customer Excellence in Hospitality",
...
export const myEmployeeDocuments = [
  ...
  {
    id: "DOC-004",
    title: "Social Security System (SSS) Form E-1",
  ...
  {
    id: "DOC-005",
    title: "Updated NBI Clearance (2026)",
    category: "Clearance",
    status: "Missing",
    date: "—",
    size: "—",
...
export const wireframeActivity = [
  ...
  },
  {
    ...
    type: "Food Safety Level 2 Course",
    date: "Aug 02, 2026",
    isoDate: "2026-08-02",
    status: "Completed",
    statusRank: 1,
  ...
  {
    category: "Attendance",
    type: "Missed Time Out Correction",
    date: "Jul 20, 2026",
    isoDate: "2026-07-20",
    status: "Pending",
    statusRank: 0,
  ...
  {
    category: "Performance",
    type: "Senior Line Cook Promotion Application",
    date: "Jul 15, 2026",
    isoDate: "2026-07-15",
    status: "Pending",
    statusRank: 0,
  ...
  {
    category: "Documents",
    type: "Certificate of Employment Request",
    date: "Jul 01, 2026",
    isoDate: "2026-07-01",
    status: "Released",
    statusRank: 1,
  ...
  {
    category: "Performance",
    type: "Customer Excellence Course",
    date: "Jun 14, 2026",
    isoDate: "2026-06-14",
    status: "Completed",
    statusRank: 1,
  ...
  {
    category: "Documents",
    type: "BIR Form 2316 Copy Request",
    date: "Jun 01, 2026",
    isoDate: "2026-06-01",
    status: "Released",
    statusRank: 1,
  ...
  {
    category: "Attendance",
    type: "Time In Correction (Late Override)",
    date: "May 22, 2026",
    isoDate: "2026-05-22",
    status: "Approved",
    statusRank: 1,
...
export const myLoginActivity = [
  {
    ...
    time: "Jul 31, 2026, 8:12 AM",
    date: "2026-07-31T08:12",
  },
  {
    device: "Mobile App · Android",
    location: "Makati City, PH",
    time: "Jul 30, 2026, 6:45 PM",
    date: "2026-07-30T18:45",
  },
  {
    device: "Edge · Windows",
    location: "Makati City, PH",
    time: "Jul 25, 2026, 9:30 AM",
    date: "2026-07-25T09:30",
  },
];
